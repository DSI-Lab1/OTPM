 ...
 * FileName: AlgoTUSQ_SRU
 * Author: dqj
 * Date: 2020/12/05 14:12
 * Description: The implementation of TUSQ algorithm without SRU strategy.
 * Pruning strategy: TDU
...
public class AlgoTUSQ_SRU {
    ...
    public void runAlgorithm(String input, String output, double utilityratio) throws IOException {
        ...
        //System.out.println("totalutility: "+totalUtility+" utilityratio:"+utilityratio+" Threshold:"+this.minUtility);
        ...
        buffer.append("============= ALGOTUSQ_SRU  v1.0 - STATS =============\n");
    ...
    //	This inner class is used to store the candidates after concatenating the item.
     ...
     * @param LOT last instance table
     */
    private void TUSQ(int[] prefix, int prefixLength, List<QMatrix> database, ArrayList<TargetedList> utilitychain, int itemCount, int[] T, ArrayList<ArrayList<Integer>>LOT) throws IOException {
    ...
    public void printStatistics() {
        System.out.println("============= ALGOTHUSSPAN v1.0 - STATS =============");
